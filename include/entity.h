...
typedef enum EntityType_s { NO_TYPE, PLAYER_TYPE,
...
INTERACTABLE_BOX, INTERACTABLE_METAL_BOX, INTERACTABLE_EXPLOSIVE, INTERACTABLE_CAR, INTERACTABLE_TRASH_CAN } EntityType;
